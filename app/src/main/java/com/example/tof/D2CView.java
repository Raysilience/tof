...
public class D2CView extends View {
    ...
    public D2CView(Context context) {
        super(context);
        init(context);
    }

    public D2CView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public D2CView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
